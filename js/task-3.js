...
// Метод getInfo() має повертати рядок формату < Username > has < amount > active hours!, де < Username > —
// це ім’я профілю, а < amount > — кількість ігрових годин.
...
const profile = {
  ...
  getInfo() {
    return `${this.username} has ${this.playTime}`;
  },
};
